...
namespace Cashed.Extensions.Tests
{
    ...
    public class DateTimeExtensionsTests
    {
        ...
        {
            Assert.AreEqual(new DateTime(2017, 12, 31, 23, 59, 59), new DateTime(2017, 12, 31, 23, 59, 59).EndOfTheMonth());
        }
        ...
        {
            Assert.AreEqual(new DateTime(2017, 10, 15, 23, 59, 59), new DateTime(2017, 10, 15, 23, 59, 59).EndOfTheWeek());
        }
    }
}